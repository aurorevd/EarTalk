...
function Command({ play, setPlay, setSpeed, noise,setNoise, subtitles, setSubtitles, mute, setMute, volume, setVolume }) {
  ...
  return (
    <StyledCommand>
      ...
      <CommandButton src={subtitles ? BubbleIcon : BubbleOffIcon} onClick={setSubtitles} />
      ...
      <CommandButton src={volume ? VolumeIcon : VolumeIcon} onClick={setVolume} />
    </StyledCommand>
  );
}
